...
contract ZkMinimalAccountTest is Test {
    ...
    // Because zksync dont work well with scripting the transaction object have to be build manually
    function _createUnsignedTransaction(
        ...
        return
            Transaction({
                txType: transactionType, // Can be whatever but now will be type 113 (0x71)
